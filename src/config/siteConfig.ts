...
export const siteConfig = {
  ...
  contact: {
    ...
    address:
      ...
      "15/15 Đống Đa, Phú Nhuận, Huế, Thành phố Huế",
    openingHours:
  ...
  social: {
    facebook:
      process.env.NEXT_PUBLIC_FACEBOOK_URL || "https://fb.com/bepnhatram.1",
    facebookHandle:
      process.env.NEXT_PUBLIC_FACEBOOK_HANDLE || "fb.com/bepnhatram.1",
    instagram: process.env.NEXT_PUBLIC_INSTAGRAM_URL || "",
    twitter: process.env.NEXT_PUBLIC_TWITTER_URL || "",
    zalo: process.env.NEXT_PUBLIC_ZALO_URL || "https://zalo.me/0886286032",
    tiktok:
      process.env.NEXT_PUBLIC_TIKTOK_URL ||
      "https://www.tiktok.com/@tramthichnauan",
    tiktokHandle: process.env.NEXT_PUBLIC_TIKTOK_HANDLE || "@tramthichnauan",
    messenger:
      process.env.NEXT_PUBLIC_MESSENGER_URL || "https://m.me/bepnhatram.1",
  },

  // Đặt hàng
  ordering: {
    shopeeFood:
      process.env.NEXT_PUBLIC_SHOPEEFOOD_URL ||
      "https://shopeefood.vn/hue/bep-nha-tram-ga-u-muoi-chan-ga",
    grabFood:
      process.env.NEXT_PUBLIC_GRABFOOD_URL ||
      "https://food.grab.com/vn/vi/restaurant/bep-nha-tram",
  },
  ...
  maps: {
    embedUrl:
      ...
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3826.2641274089488!2d107.59194319999999!3d16.462158199999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3141a10027198345%3A0x96561dba360403e1!2zQuG6v3AgTmjDoCBUcsOibQ!5e0!3m2!1svi!2s!4v1746188965268!5m2!1svi!2s",
    directionsUrl:
      process.env.NEXT_PUBLIC_MAPS_DIRECTIONS_URL ||
      "https://maps.app.goo.gl/oSWx2zEwL6VCU4Hf7",
  ...
  seo: {
    titleTemplate:
      process.env.NEXT_PUBLIC_SEO_TITLE_TEMPLATE || "%s - BẾP NHÀ TRÂM",
    defaultTitle:
      process.env.NEXT_PUBLIC_SEO_DEFAULT_TITLE ||
      "BẾP NHÀ TRÂM - Món ăn ngon tại Huế",
    defaultDescription:
    ...
    ogImageUrl:
      process.env.NEXT_PUBLIC_SEO_OG_IMAGE_URL || "/logo-removebg.png",
    twitterHandle: process.env.NEXT_PUBLIC_SEO_TWITTER_HANDLE || "@bepnhatram",
    keywords:
      process.env.NEXT_PUBLIC_SEO_KEYWORDS ||
      "bếp nhà trâm, nhà hàng huế, gà ủ muối, chân gà rút xương, đặc sản huế, ẩm thực huế",
