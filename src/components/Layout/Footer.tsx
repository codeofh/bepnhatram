...
export function Footer({ siteSettings = defaultSiteConfig }: FooterProps) {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            ...
            <p className="text-gray-700 text-sm">{siteSettings.description}</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center text-gray-700 hover:text-blue-600 transition-colors">
              ...
              <span>
                {siteSettings.contact?.phone || defaultSiteConfig.contact.phone}
              </span>
            </div>
            <div className="flex items-center text-gray-700 hover:text-blue-600 transition-colors">
              <Mail size={18} className="mr-2 text-blue-500" />
              <span>
                {siteSettings.contact?.email || defaultSiteConfig.contact.email}
              </span>
            </div>
            <div className="flex items-center text-gray-700">
              ...
              >
                {siteSettings.social?.facebookHandle ||
                  defaultSiteConfig.social.facebookHandle}
              </a>
            </div>
            <div className="flex items-center text-gray-700">
              <svg
              ...
              <a
                href={
                  siteSettings.social?.tiktok || defaultSiteConfig.social.tiktok
                }
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                {siteSettings.social?.tiktokHandle ||
                  defaultSiteConfig.social.tiktokHandle}
              </a>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center text-gray-700">
              ...
              <a
                href={
                  siteSettings.ordering?.shopeeFood ||
                  defaultSiteConfig.ordering.shopeeFood
                }
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="flex items-center text-gray-700">
              ...
              <a
                href={
                  siteSettings.ordering?.grabFood ||
                  defaultSiteConfig.ordering.grabFood
                }
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="flex items-center text-gray-700">
              ...
              <a
                href={
                  siteSettings.social?.messenger ||
                  defaultSiteConfig.social.messenger
                }
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-600 transition-colors"
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center text-gray-700 hover:text-blue-600 transition-colors">
              ...
              <span>
                {siteSettings.contact?.openingHours ||
        ...
        <div className="border-t border-gray-200 mt-6 pt-6 text-center">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} {siteSettings.name}. Tất cả các quyền
            được bảo lưu.
          </p>
        </div>
      </div>
