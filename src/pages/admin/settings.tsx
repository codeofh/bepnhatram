        ...
        <div className="max-w-full overflow-hidden px-0">
          {settingsLoading ? (
            ...
            <form onSubmit={handleSubmit} className="max-w-full">
              <div className="space-y-5 pb-16 md:pb-0 overflow-hidden">
                <div className="mb-5">
                ...
                <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-3 z-40 flex gap-3 md:hidden shadow-[0_-2px_10px_rgba(0,0,0,0.05)] max-w-full box-border">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={handleReset}
                  ...
                  <Button
                    type="submit"
                    disabled={isSubmitting}
                    className="flex-1 h-11 text-sm font-medium bg-black text-white"
                  >
                    {isSubmitting ? (
                      <>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                  <div className="bg-gray-50 -mx-2 px-2 py-2 mb-4">
                  ...
                  <TabsContent value="general">
                    ...
                    <Card className="rounded-lg border shadow-sm max-w-full overflow-hidden">
                      ...
                      <CardContent className="space-y-4 px-3 pb-4 pt-0 overflow-hidden">
