...
export default function AdminSettingsPage() {
  ...
  const { settings, loading: settingsLoading, error: settingsError, updateSettings, resetToDefaults } = useSettingsContext();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        debugLog(`Firebase error: ${firebaseError?.message || 'Unknown error'}`);
        showError(`Lỗi kiểm tra Firebase: ${firebaseError?.message || 'Lỗi không xác định'}`);
        return;
      }
      ...
      if (success) {
        ...
        console.error("[AdminSettings] Update failed. Current error state:", settingsError);
      ...
      showError(`Đã xảy ra lỗi khi cập nhật cài đặt: ${error.message || 'Lỗi không xác định'}`);
    } finally {
  ...
  const handleReset = async () => {
    if (window.confirm("Bạn có chắc ch��n muốn khôi phục về cài đặt mặc định? Thao tác này không thể hoàn tác.")) {
      try {
        ...
        if (success) {
          ...
          console.error("[AdminSettings] Reset failed. Current error state:", settingsError);
        ...
        console.error("[AdminSettings] Exception during settings reset:", error);
        console.error("[AdminSettings] Error message:", error.message);
        console.error("[AdminSettings] Error stack:", error.stack);

        showError(`Đã xảy ra lỗi khi khôi phục cài đặt mặc định: ${error.message || 'Lỗi không xác định'}`);
      }
    }
  };
                      ...
                      <div className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("contact", "openingHours", e.target.value)}
                          />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="grid gap-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => handleChange("contact", "region", e.target.value)}
                            />
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="grid gap-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => handleChange("contact", "postalCode", e.target.value)}
                            />
                          </div>
                      ...
                      <div className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("social", "facebookHandle", e.target.value)}
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("social", "tiktokHandle", e.target.value)}
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("social", "messenger", e.target.value)}
                      ...
                      <div className="grid gap-4">
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("ordering", "shopeeFood", e.target.value)}
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("ordering", "grabFood", e.target.value)}
                      ...
                      <div className="grid gap-4">
                        <div className="grid gap-2">
                          ...
                          <Textarea
                            ...
                            onChange={(e) => handleChange("maps", "embedUrl", e.target.value)}
                            rows={3}
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("maps", "directionsUrl", e.target.value)}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="grid gap-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => handleChange("maps", "latitude", e.target.value)}
                              placeholder="16.462..."
                            />
                          </div>
                          ...
                          <div className="grid gap-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => handleChange("maps", "longitude", e.target.value)}
                              placeholder="107.591..."
                            />
                          </div>
                        </div>
                      ...
                      <div className="grid gap-4">
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("seo", "titleTemplate", e.target.value)}
                            placeholder="%s - Tên trang web"
                          />
                          <p className="text-xs text-muted-foreground">Sử dụng %s để đặt vị trí tiêu đề trang</p>
                        </div>
                        ...
                        <div className="grid gap-2">
                          <Label htmlFor="ogImageUrl">URL hình ảnh chia sẻ</Label>
                          <Input
                            id="ogImageUrl"
                            value={formData.seo.ogImageUrl}
                            onChange={(e) => handleChange("seo", "ogImageUrl", e.target.value)}
                        ...
                        <div className="grid gap-2">
                          ...
                          <Textarea
                            ...
                            rows={2}
                          />
                          <p className="text-xs text-muted-foreground">Các từ khóa cách nhau bằng dấu phẩy</p>
                        </div>

                        <div className="grid gap-2">
                          <Label htmlFor="homePageTitle">Tiêu đề trang chủ</Label>
                          <Input
                            id="homePageTitle"
                            value={formData.seo.homePageTitle}
                            onChange={(e) => handleChange("seo", "homePageTitle", e.target.value)}
                          />
                        </div>
                      </div>
                    </CardContent>
                      ...
                      <div className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("settings", "currencySymbol", e.target.value)}
                          />
                        </div>
                        ...
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleChange("settings", "locale", e.target.value)}
                          />
                        </div>
                      </div>
                    </CardContent>
