  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (loading) {
        ...
        if (!order) {
          setError(
            "Không thể tải thông tin đơn hàng. Vui lòng kiểm tra trong mục đơn hàng của bạn.",
          );
        }
      }
          ...
          <CardContent className="pt-4 pb-6">
            <div className="text-center mb-6">
              <p className="text-gray-600">
                Cảm ơn bạn đã đặt hàng tại BẾP NHÀ TRÂM. Chúng tôi sẽ liên hệ
                với bạn trong thời gian sớm nhất để xác nhận đơn hàng.
              </p>
            </div>
            ...
            {loading ? (
              ...
              <Alert className="mb-4">
                ...
                <AlertDescription>
                  Đơn hàng của bạn đã được tạo, nhưng hệ thống không thể hiển
                  thị chi tiết đơn hàng lúc này.
                </AlertDescription>
              </Alert>
            ) : order ? (
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  {order.payment?.method === "bank_transfer" && (
                    <div className="mt-3 p-3 bg-blue-50 rounded-md text-sm">
                      ...
                      <p>
                        Tên tài khoản:{" "}
                        <span className="font-medium">NGUYEN THI TRAM</span>
                      </p>
                      <p>
                        Số tài khoản:{" "}
